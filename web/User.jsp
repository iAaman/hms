        ...
        <div id="header">
           ...
           <div id="tab">
                <ul>
                    ...
                    <li> <a href="viewInfo.jsp">My profile</a><img id="prfpic" src="https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX17744241.jpg"/></li>
...
<select class ="bc" name=?browsers? required>
        ...
        <script>
             ...
             function send_me(){
                 ...
                 window.location.href='http://localhost:8084/HMS_1.05/Roomdetails.jsp';
